...
@section('content')
  <div id="coinpayment-vue">
    <div class="text-center mt-3 mb-3" style="background: rgba(74, 111, 197, 0.9) !important;">
        <a href="{{url('/dashboard')}}" style="color: white">
            <img  class="img-responsive img-fluid" src="{{url('public/images/logos/'.getCompanyLogo())}}" width="180">
        </a>
    </div>
    <hr>
              ...
              <div class="float-right">
                <div class="dropdown dropleft float-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="#" v-on:click="manualCheck($event, item)">
