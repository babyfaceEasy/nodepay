...
return [
    ...
    'google2fa'        => [
        ...
        'subheader-text' => 'مسح QR Code باستخدام تطبيق Google Authenticator.',
        'setup-a'        => 'قم بإعداد تطبيق Google Authenticator قبل المتابعة.',
        'setup-b'        => 'لن تتمكن من التحقق من خلاف ذلك.',
        'proceed'        => 'الشروع في التحقق',
        'otp-title-text' => 'كلمة مرور واحدة (OTP)',
        'otp-input'      => 'أدخل OTP المكون من 6 أرقام من تطبيق Google Authenticator',
    ...
    'home'             => [
        ...
        'services'        => [
            ...
            's1' => 'ستدير تجربة العملاء المدفوعة الأجر عن طريق دمج واجهة API المتداخلة في موقعك على الويب.',
...
                            بوابة بعملات مختلفة.',
        ...
        'section-e' => [
            'title'   => 'أسرع وأبسط وأكثر أمانا - إرسال الأموال لمن تحب اليوم.',
            'sign-up' => 'قم بالتسجيل في payMoney',
    ...
    'dashboard'        => [
        ...
        'payout'       => [
            ...
            'new-payout'     => [
                ...
                'success'        => 'نجاح',
                'payout-success' => 'مبلغ العائد الناجح',
