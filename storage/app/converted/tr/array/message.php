...
return [
    ...
    'google2fa'        => [
        ...
        'subheader-text' => 'Google Authenticator Uygulaması ile QR Kodunu tarayın.',
        'setup-a'        => 'Devam etmeden önce Google Authenticator uygulamanızı kurun.',
        'setup-b'        => 'Aksini doğrulayamayacaksınız.',
        'proceed'        => 'Doğrulamaya Devam Et',
        'otp-title-text' => 'Tek Kullanımlık Şifre (OTP)',
        'otp-input'      => 'Google Authenticator Uygulamasından 6 haneli OTP\'yi girin',
    ...
    'home'             => [
        ...
        'banner'          => [
            'title'      => 'Basit para transferi için: sevdiklerinize br.',
            'sub-title1' => 'Basit: Entegre Ol',
            'sub-title2' => 'Çoklu: br Cüzdan',
            'sub-title3' => 'Gelişmiş: br Güvenlik',
        ...
        'services'        => [
            't1' => 'Ödeme API\'sı',
            's1' => 'Sorunsuz API arayüzümüzü web sitenize entegre ederek müşterilerin paypal deneyimini yönetir.',
    ...
    'send-money'       => [
        ...
        'banner'    => [
            ...
            'sign-up'   => 'Para ödemek için üye olun',
...
                            hesaplarına aktarıldı.',
        ...
        'section-c' => [
            'title'     => 'Anında Para Ödemeli Sistem Kullanarak İsteyen Herkesin Parasını Gönderin',
            'sub-title' => 'Pay Money mobil uygulaması, banka aracılığıyla küresel olarak arkadaşlarınıza ve ailenize para transferi yapın
                            hesabınız veya başkaları ödeme ağ geçidi.
                            herhangi bir hesabınız olsun veya olmasın. Farklı ödeme türleri ile para gönderebilir / talep edebilirsiniz
                            Farklı para birimleri ile ağ geçidi.',

        ],
        'section-d' => [
            'title'   => 'Daha hızlı, Daha basit, Daha güvenli - Bugün sevdiğiniz kişilere para gönderin.',
            'sign-up' => 'Para ödemek için kayıt',
...
                            hesap, paypal bakiyesi veya diğer ödeme yolu. Basit bir e-posta ile bilgilendirileceksiniz.',
    ...
    'request-money'    => [
        ...
        'section-a' => [
            ...
            'sub-title'     => 'Para talep etmek, borçlu olduğunuz parayı sormanın verimli ve kibar bir yoludur. : br Kullanım
                            payMoney sistemi para göndermek, para almak ya da en yakın ve en sevecen para transfer etmek
                            olanlar.',
...
                            hesap, paypal bakiyesi veya diğer ödeme yolu. Basit bir e-posta ile bilgilendirileceksiniz.',
        ...
        'section-c' => [
            'title'     => 'Kolayca Para Istemek için payMoney Mobile App kullanın.',
...
                            değil. Paypal, şerit, 2 çek ve daha birçok ödeme yolu ile ödeme yapabilirler.',
        ...
        'section-d' => [
            'title'     => 'PayMoney Sistemini Kullanarak Anında Herkesin Parasını İsteyin',
            'sub-title' => 'PayMoney mobil uygulaması, banka aracılığıyla küresel olarak arkadaşlarınıza ve ailenize para transferi yapın
                            hesap veya diğer ödeme ağ geçidi. Para, doğrudan alıcıya hesabınıza girer
                            herhangi bir hesabınız olsun veya olmasın. Farklı ödeme türleri ile para gönderebilir / talep edebilirsiniz
                            Farklı para birimleri ile ağ geçidi.',
    ...
    'dashboard'        => [
        ...
        'payout'       => [
            ...
            'new-payout'     => [
                ...
                'success'        => 'başarı',
                'payout-success' => 'Ödeme tutarı başarılı',
        ...
        'vouchers'     => [
            ...
            'right'               => [
                ...
                'amount'    => 'Miktar',
                'status'    => 'durum',
                'not-found' => 'Makbuz bulunamadı!',

            ],
            'confirmation'        => [
                'title'     => 'Kupon oluştur',
                'sub-title' => 'Kupon oluşturmak üzeresiniz',
                'amount'    => 'fiş tutarı',

            ],
            'active-confirmation' => [
                'title'     => 'Aktif kefil',
                'sub-title' => 'Aktif kupon kodu hakkında',
                'amount'    => 'fiş tutarı',
            ...
            'ajax-response'       => [
                'voucher-code-error'         => 'Kupon Zaten Aktif!',
                'voucher-code-pending-error' => 'Üzgünüz, bekleyen kupon etkinleştirilemiyor!',
                'voucher-not-found'          => 'Üzgünüz, fiş bulunamadı!',
