...
return [
    ...
    'google2fa'        => [
        ...
        'subheader-text' => 'Escanear el código QR con la aplicación Google Authenticator.',
        'setup-a'        => 'Configure su aplicación Google Authenticator antes de continuar.',
        'setup-b'        => 'No podrás verificar lo contrario.',
        'proceed'        => 'Proceder a la verificación',
        'otp-title-text' => 'Contraseña de una sola vez (OTP)',
        'otp-input'      => 'Ingrese la OTP de 6 dígitos de la aplicación Google Authenticator',
...
                            cuenta, saldo de paypal u otra vía de pago. Lo notificarás a través de un simple email.',
    ...
    'request-money'    => [
        ...
        'section-a' => [
            ...
            'sub-title'     => 'Solicitar dinero es una forma eficiente y educada de pedir el dinero que se le debe. : br Uso
                            Sistema payMoney para enviar dinero, recibir dinero o transferir dinero de su más cercano y querido
                            unos',
...
                            cuenta, saldo de paypal u otra vía de pago. Lo notificarás a través de un simple email.',
        ...
        'section-c' => [
            ...
            'sub-title' => 'Cualquier persona con una dirección de correo electrónico puede recibir una solicitud de pago, ya sea que tenga una cuenta o
                            no. Te pueden pagar con PayPal, Stripe, 2checkout y muchas más opciones de pago.',
    ...
    'dashboard'        => [
        ...
        'payout'       => [
            ...
            'new-payout'     => [
                ...
                'success'        => 'Éxito',
                'payout-success' => 'Cantidad de pago exitosa',
