...
INSERT INTO migrations VALUES("35","2018_02_07_053417_create_trans_fees_table","12");
INSERT INTO migrations VALUES("36","2018_02_09_121049_create_payment_methods_table","12");
INSERT INTO migrations VALUES("38","2018_02_09_121858_create_payment_method_fees_table","13");
...
CREATE TABLE IF NOT EXISTS `payment_method_trans_fee` (
  `payment_method_id` int(10) unsigned NOT NULL,
  `trans_fee_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`payment_method_id`,`trans_fee_id`),
  KEY `payment_method_trans_fee_trans_fee_id_foreign` (`trans_fee_id`),
  CONSTRAINT `payment_method_trans_fee_payment_method_id_foreign` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_methods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `payment_method_trans_fee_trans_fee_id_foreign` FOREIGN KEY (`trans_fee_id`) REFERENCES `trans_fees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO payment_method_trans_fee VALUES("3","5");
INSERT INTO payment_method_trans_fee VALUES("2","6");
INSERT INTO payment_method_trans_fee VALUES("3","7");
...
INSERT INTO payment_methods VALUES("3","Swift","Active");
...
INSERT INTO settings VALUES("52","mode","live","PayPal");
INSERT INTO settings VALUES("53","publishable","pk_test_c2TDWsd","Stripe");
INSERT INTO settings VALUES("54","secret","sk_test_UWTsd","Stripe");
...
INSERT INTO settings VALUES("75","publishable","02020202","Swift");
INSERT INTO settings VALUES("76","secret","01010101","Swift");
...
INSERT INTO trans_fees VALUES("5","Withdrawl","10.00","200.00");
INSERT INTO trans_fees VALUES("6","Deposit","20.00","300.00");
INSERT INTO trans_fees VALUES("7","Deposit","40.00","500.00");
