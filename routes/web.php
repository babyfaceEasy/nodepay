...
//coinPayment
Route::get('deposit/coinpayments/check', 'DepositController@coinpaymentsCheckStatus'); //cron job for deposit to update status and wallet table
Route::post('deposit/coinpayments_success', 'DepositController@coinpaymentsPaymentSuccess');
Route::get('deposit/coinpayments_fail', 'DepositController@coinpaymentsPaymentFail');
...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['guest:admin', 'locale']], function ()
{
    ...
    Route::post('change-password/{id}', 'AdminController@updatePassword');
...
Route::group(['middleware' => ['guest:users', 'locale', 'twoFa'], 'namespace' => 'Users'], function ()
{
    ...
    Route::group(['middleware' => ['permission:manage_deposit']], function ()
    {
        ...
        Route::post('postajax', 'DepositController@postajax');

        /// Deposit By Payment Method
        Route::get('deposit/method/{id}', 'DepositController@selectMethod');
        ...
        Route::get('deposit/skrill_payment', 'DepositController@skrillPayment');
        Route::post('deposit/skrill_payment_store', 'DepositController@skrillPaymentStore'); //not added
        Route::get('deposit/checkout_payment', 'DepositController@checkoutPayment');
        Route::get('deposit/checkout_payment_store', 'DepositController@checkoutPaymentStore');
        ...
        Route::get('deposit/payumoney_fail', 'DepositController@payumoneyPaymentFail');
    ...
    Route::group(['middleware' => ['permission:manage_withdrawal']], function ()
    {
        ...
        Route::post('postajax', 'WithdrawalController@withdrawalPostAjax');
    ...
    Route::group(['middleware' => ['permission:manage_transfer']], function ()
    {
        ...
        Route::post('transferEmailValidate', 'MoneyTransferController@transferEmailValidate');
        Route::post('amount-limit', 'MoneyTransferController@amountLimitCheck');
        Route::post('deposit/amount-limit', 'DepositController@amountLimitCheck');
    ...
    Route::group(['middleware' => ['permission:manage_exchange']], function ()
    {
        ...
        Route::post('exchange_of_base_currency', 'ExchangeController@exchangeOfBaseCurrency');
        Route::post('exchange_to_base_currency', 'ExchangeController@exchangeToBaseCurrency');
        Route::get('exchange/view/{id}', 'ExchangeController@view');
        Route::post('exchange/amount-limit-check', 'ExchangeController@amountLimitCheck');
        Route::get('exchange/exchange-of-base-currency-confirm', 'ExchangeController@exchangeOfBaseCurrencyConfirm');
        Route::get('exchange/exchange-to-base-currency-confirm', 'ExchangeController@exchangeToBaseCurrencyConfirm');
        Route::get('get-wallets', 'ExchangeController@getWallet');
    ...
    Route::group(['middleware' => ['permission:manage_request_payment']], function ()
    {
        ...
        Route::post('request_payment/fee', 'RequestPaymentController@feeRequestPayment');
...
Route::get('payment/payumoney_fail', 'MerchantPaymentController@payuPaymentFail');

//CoinPayments
Route::post('payment/coinpayments', 'MerchantPaymentController@coinPayments');
Route::post('payment/coinpayments_success', 'MerchantPaymentController@coinPaymentsSuccess');
...
Route::get('payment/coinpayments_fail', 'MerchantPaymentController@coinPaymentsFail');
