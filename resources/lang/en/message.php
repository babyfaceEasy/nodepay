...
return [
    ...
    'home'             => [
        ...
        'services'        => [
            't1' => 'Payment API',
            's1' => 'It will manage customers’ paymoney experience by integrating our seamless API interface within your website.',
            't2' => 'Online Payments',
            ...
            't5' => 'Voucher System',
            's5' => 'Issue & manage your own branded or gifted vouchers ',
            't6' => 'Fraud Detection',
    ...
    'send-money'       => [
        ...
        'section-c' => [
            ...
            'sub-title' => 'Transfer funds to your friends & family globally through the Pay Money mobile app, bank
                            account or others payment gateway.Funds directly go into your account whether the recipient
                            have any account or not. You can send/request for money via different type of Payment
                            Gateway with different currencies.',
        ],
        'section-d' => [
            'title'   => 'Faster, Simpler, Safer – Send Money To Those You Love Today.',
            'sign-up' => 'SignUp To Pay Money',
        ],
        'section-e' => [
            ...
            'sub-title' => 'Now, you have no trouble for having cash money. Anyone can send money from their card, bank
                            account, paypal balance or other paymentgateway. You will notify via an simple email.',
        ],
    ],
    //end the first
    'request-money'    => [
        'banner'    => [
            'title'          => 'Request Money From Around The World :br With Pay Money',
            'sub-title'      => 'Make a reminder people to send moneyback.',
            'sign-up'        => 'Sign Up To payMoney',
        ...
        'section-a' => [
            ...
            'sub-title'     => 'Requesting money is an efficient and polite way of asking for money you\'re owed. :br Use
                            payMoney system to send money, receive money or transfer money from your nearest & dearest
                            ones.',
            'sub-section-1' => [
                'title'     => 'Register Account',
                'sub-title' => 'At first be an register user, then login into your account and enter your card or bank
        ...
        'section-c' => [
            'title'     => 'Use the payMoney Mobile App To Easily Request Money.',
            'sub-title' => 'Anyone with an email address can receive a payment request, whether they have an account or
                            not. They can pay you with a paypal, stripe, 2checkout and many more paymentgateway.',
        ],
        'section-d' => [
            'title'     => 'Request Money To Anyone, Anywhere, Instantly Using payMoney System',
            'sub-title' => 'Transfer funds to your friends & family globally through the payMoney mobile app, bank
                            account or others payment gateway. Funds directly go into your account whether the recipient
                            have any account or not. You can send/request for money via different type of Payment
                            Gateway with different currencies.',
        ],
    ...
    'dashboard'        => [
        ...
        'payout'       => [
            ...
            'new-payout'     => [
                ...
                //new
                'success'        => 'Success',
                'payout-success' => 'Payout amount successful',
        ...
        'vouchers'     => [
            ...
            'right'               => [
                ...
                'amount'    => 'Amount',
                'status'    => 'Status',
                'not-found' => 'Voucher not found!',
            ],
            'confirmation'        => [
                'title'     => 'Create Voucher',
                'sub-title' => 'You are about to create voucher',
                'amount'    => 'Voucher Amount',
            ],
            'active-confirmation' => [
                'title'     => 'Activated Vouched',
                'sub-title' => 'You are about to active voucher code',
                'amount'    => 'Voucher Amount',
            ],
            //new
            'success'             => [
            ...
            'ajax-response'       => [
                'voucher-code-error'         => 'Voucher Already Activated!',
                'voucher-code-pending-error' => 'Sorry, Cannot activate pending voucher!',
                'voucher-not-found'          => 'Sorry, voucher not found!',
            ],
        ],
