  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form method="POST" action="{{ url('admin/settings/edit_country/'.$result->id) }}" class="form-horizontal" id="edit_country_form">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="short_name" class="form-control" placeholder="short name" id="short_name" value="{{ $result->short_name }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="name" class="form-control" placeholder="long name" id="name" value="{{ $result->name }}">
                @if($errors->has('name'))
                <span class="help-block">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="iso3" class="form-control" placeholder="iso3" id="iso3" value="{{ $result->iso3 }}">
                @if($errors->has('iso3'))
                <span class="help-block">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="number_code" class="form-control" placeholder="number code" id="number_code" value="{{ $result->number_code }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="phone_code" class="form-control" placeholder="phone code" id="phone_code" value="{{ $result->phone_code }}">
