...
@section('page_content')
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/withdrawals') }}" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="currency" id="currency">
                                    ...
                                    @foreach($w_currencies as $withdrawal)
                                        <option value="{{ $withdrawal->currency_id }}" {{ ($withdrawal->currency_id == $currency) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="status" id="status">
                                    ...
                                    @foreach($w_status as $withdrawal)
                                      <option value="{{ $withdrawal->status }}" {{ ($withdrawal->status == $status) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="payment_methods" id="payment_methods">
                                    ...
                                    @foreach($w_pm as $withdrawal)
                                      <option value="{{ $withdrawal->payment_method_id }}" {{ ($withdrawal->payment_method_id == $pm) ? 'selected' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-8">
                                    <h3 class="panel-title">All Payouts</h3>
                                </div>
                                <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url('admin/withdrawals/user_search')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
    ...
    $(document).ready(function()
    {
        $('#csv').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/withdrawals/csv?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&currency="+currency
    ...
    $(document).ready(function()
    {
        $('#pdf').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/withdrawals/pdf?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&currency="+currency
          +"&payment_methods="+payment_methods
