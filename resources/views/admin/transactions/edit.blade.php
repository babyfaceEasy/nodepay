										...
										<div class="panel-body">
											...
											@if ($transactions->file)
												<div class="form-group">
													...
													<div class="col-sm-9">
													  <p class="form-control-static">
										                  <a href="{{ url('public/uploads/files/bank_attached_files').'/'.$transactions->file->filename }}"><i class="fa fa-fw fa-download"></i>
										...
										<div class="panel-body">
													...
													<span>
														<small class="transactions-edit-fee">
															@if (isset($transactions))
																({{($transactions->percentage)}}% + {{ $transactions->charge_fixed }})
															@else
																({{0}}%+{{0}})
															@endif
														</small>
											...
											@if ($transactions->total)
							                    <div class="form-group total-deposit-space">
													<label class="control-label col-sm-4 pull-left" for="total">Sum</label>
