...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url('admin/transactions_user_search')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
    ...
    $(document).ready(function()
    {
        $('#csv').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/transactions/csv?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&currency="+currency
          +"&type="+type
    ...
    $(document).ready(function()
    {
        $('#pdf').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/transactions/pdf?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&currency="+currency
          +"&type="+type
