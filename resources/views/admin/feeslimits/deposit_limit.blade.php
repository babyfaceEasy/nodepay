        ...
        <form action='{{url('admin/settings/feeslimit/update-deposit-limit')}}' class="form-horizontal" method="POST" id="deposit_limit_form">
          ...
          <div class="box-body">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input class="form-control min_limit" name="min_limit" type="text" value="{{ isset($feeslimit->min_limit) ? $feeslimit->min_limit : 1 }}" id="min_limit">
...
<script type="text/javascript">
    ...
    {
        if($(".has_transaction").prop('checked') == true)
        {
          $('#has_transaction').val('Yes')
          $("#min_limit").prop("readonly", !this.checked);
          $("#max_limit").prop("readonly", !this.checked);
          $("#charge_percentage").prop("readonly", !this.checked);
          $("#charge_fixed").prop("readonly", !this.checked);
          $("#processing_time").prop("readonly", !this.checked);
        }else{
