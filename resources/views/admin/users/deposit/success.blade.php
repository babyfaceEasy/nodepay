                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                  <a href="{{url("admin/users/deposit/print/$transaction->id")}}" target="_blank" class="btn button-secondary"><strong>@lang('message.dashboard.vouchers.success.print')</strong></a>
                            </div>
                            <div style="float: right;">
                                <a href="{{url("admin/users/deposit/create/$user_id")}}" class="btn button-secondary"><strong>Deposit Again</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
