                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="text-center"><p><strong>Payout completed successfully!</strong></p></div>
                                    <h5 class="text-center mt10">@lang('message.dashboard.payout.new-payout.amount') : {{ moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal)) }}</h5>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                  <a href="{{url("admin/users/withdraw/print/$transaction->id")}}" target="_blank" class="btn button-secondary"><strong>@lang('message.dashboard.vouchers.success.print')</strong></a>
                            </div>
                            <div style="float: right;">
                                <a href="{{url("admin/users/withdraw/create/$user_id")}}" class="btn button-secondary"><strong>@lang('message.dashboard.payout.new-payout.payout-again')</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
