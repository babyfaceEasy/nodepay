...
@section('page_content')
    ...
    <div class="row">
        <div class="col-md-2">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="margin-top: 15px;"  type="button" class="btn button-secondary btn-flat active">@lang('message.dashboard.button.payout')</button>
        </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">@lang('message.dashboard.deposit.amount')</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <small id="walletlHelp" class="form-text text-muted">
                                            ...
                                            @lang('message.dashboard.deposit.total-fee-admin') <span class="total_fees">0.00</span>
                                        </small>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-5">
                                    ...
                                    <button type="submit" class="btn button-secondary" id="send_money">
                                        ...
                                        <span id="send_text">@lang('message.dashboard.button.next')&nbsp;<i class="fa fa-angle-right"></i></span>
                                    </button>
                                </div>
                            </div>
                        </div>
