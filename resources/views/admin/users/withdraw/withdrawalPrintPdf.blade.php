		...
		<tr>
		  <td>
		   ...
		   <table>
				...
				<tr>
				<td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">@lang('message.dashboard.left-table.withdrawal.withdrawan-with')</td>
				</tr>
				<tr>
		  ...
		  <td>
		   ...
		   <table style="margin-top:20px; width:300px;">
			  ...
			  <tr>
				...
				<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transactionDetails->currency->symbol, (str_replace("-",'', formatNumber($transactionDetails->total)))) }}</td>
			  </tr>
			  </table>
		    </td>
		  </tr>
