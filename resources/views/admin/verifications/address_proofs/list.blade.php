...
@section('page_content')
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/address-proofs') }}" method="GET">
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-8">
                                    <h3 class="panel-title">All Address Verifications</h3>
                                </div>
                                <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        $('#csv').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/address-proofs/csv?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
        });
    });
    ...
    $(document).ready(function()
    {
        $('#pdf').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/address-proofs/pdf?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
        });
    });
