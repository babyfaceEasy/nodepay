				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="row">
								<div class="col-md-10">
									<h4 class="text-left">Address Verification Details</h4>
								</div>
								<div class="col-md-2">
						...
						<div class="panel-body">
							<div class="row">
								<form action="{{ url('admin/address-proofs/update') }}" class="form-horizontal" id="deposit_form" method="POST">
										{{ csrf_field() }}
									...
									<div class="row">
										<div class="col-md-11">
											...
											<div class="col-md-2"><a id="cancel_anchor" class="btn btn-danger pull-left" href="{{ url('admin/address-proofs') }}">Cancel</a></div>
											<div class="col-md-1">
