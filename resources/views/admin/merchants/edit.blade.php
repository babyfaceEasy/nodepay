							...
							<div class="col-md-7">
								...
								{{-- @if ($merchant->fee) --}}
				                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="fee" value="{{ ($merchant->fee != '0.00') ? formatNumber($merchant->fee) : 0.00 }}" id="fee">
											@if($errors->has('fee'))
												<span class="error">
			                    ...
			                    <div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="file" name="logo" class="form-control input-file-field" data-rel="{{ isset($merchant->logo) ? $merchant->logo : '' }}" id="logo"
									  	value="{{ isset($merchant->logo) ? $merchant->logo : '' }}">
	...
	$(document).ready(function()
    {
	    $("#merchantGroup").change(function()
	    {
	        ...
	        .done(function(response)
	        {
				...
				{
				 	$('#fee').val(parseFloat(response.fee).toFixed(2));
				}
	        });
	    });
	});
