...
@section('page_content')
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/merchants') }}" method="GET">
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-8">
                                    <h3 class="panel-title">All Merchants</h3>
                                </div>
                                <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{ url('admin/merchants/userSearch') }}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
    ...
    $(document).ready(function()
    {
        $('#csv').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/merchants/csv?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&user_id="+user_id;
        });
    ...
    $(document).ready(function()
    {
        $('#pdf').on('click', function(event)
        {
          ...
          window.location = SITE_URL+"/admin/merchants/pdf?startfrom="+startfrom
          +"&endto="+endto
          +"&status="+status
          +"&user_id="+user_id;
        });
