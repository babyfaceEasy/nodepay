            ...
            <form action="{{ url('admin/settings') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                ...
                <!-- box-body -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="head_code" placeholder="head_code" rows="3" class="form-control">{{ @$result['head_code'] }}</textarea>
        ...
        $("#login_via").change(function()
        {
            if ($(this).val() == 'email_or_phone' || $(this).val() == 'phone_only')
            {
              $.ajax({
                ...
                async : false, //Script stops and waits for the server to send back a reply before continuing
              })
