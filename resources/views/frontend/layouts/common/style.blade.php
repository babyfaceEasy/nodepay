...
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/prereset.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/customstyle.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/font-awesome-4.7.0/css/font-awesome.min.css')}}">
@yield('styles')