                                    ...
                                    <form action="{{ url('authenticate') }}" method="post" id="login_form">
                                        ...
                                        @elseif(isset($setting['login_via']) && $setting['login_via'] == 'phone_only')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="phoneHelp" placeholder="@lang('message.login.phone')" name="phone_only" id="phone_only" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
...
<script src="{{ url('public/backend/fingerprintjs2/fingerprint2.js') }}" type="text/javascript"></script>
