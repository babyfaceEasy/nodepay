					  ...
					  <td>
					   <table style="margin-top:20px; width:300px;">
						  ...
						  <tr style="padding-bottom:10px;">
							...
							<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transaction->currency->symbol, formatNumber($transaction->charge_percentage + $transaction->charge_fixed)) }}</td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							...
							<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal + $transaction->charge_percentage + $transaction->charge_fixed)) }}</td>
						  </tr>
						  </table>
					    </td>
					  </tr>
