...
<header id="js-header-old">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary toogleMenuDiv" style="max-height: 63px;">
        <div class="container">
            ...
            {{-- <div class="d-none d-lg-block" style="width: 270px;"> --}}
            <div class="d-none d-lg-block" style="width: 229px;">
                <div class="row">
                    ...
                    <div class="col-md-9 username text-left">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{$user->first_name.' '.$user->last_name}}</a>
...
<!--Start Section-->
<!-- <section class="section-06 menu-bgcolor marginTopMinnus d-none d-sm-block"> -->
