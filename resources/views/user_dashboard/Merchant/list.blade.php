                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label>@lang('message.dashboard.merchant.html-form-generator.price'), {{session('currency_code')}}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="html" id="result" rows="8" disabled>
                                        <form method="POST" action="{{url('/payment/form')}}">
                                            ...
                                            <button type="submit">Test payment form</button>
                                        </form>
                                    </textarea>
        ...
        var result = document.getElementById('result'),
            ...
            btn.onclick = function ()
            {
                var val1 = f1.value,
                    ...
                    val5 = f5.value;
                    val6 = f6.value;
                result.value = '<form method="POST" action="' + SITE_URL + '/payment/form"><input type="hidden" name="merchant" value="' + val1 + '" /><input type="hidden" name="merchant_id" value="' + val6 + '" /><input type="hidden" name="item_name" value="' + val2 + '" /><input type="hidden" name="order" value="' + val3 + '" /><input type="hidden" name="amount" value="' + val4 + '" /><input type="hidden" name="custom" value="' + val5 + '" /><button type="submit">Pay now!</button></form>';
            }
