                                    ...
                                    <table class="table recent_activity" id="merchant">
                                        ...
                                        @foreach($merchant_payments as $result)
                                            <tr>
                                                ...
                                                <td>{{ formatNumber($result->charge_percentage) }}</td>
                                                ...
                                                @if($result->status == 'Pending')
                                                    <td>
                                                        <span class="badge badge-warning">@lang('message.dashboard.merchant.payment.pending')</span>
                                                    </td>
                                                ...
                                                @elseif($result->status == 'Refund')
                                                    <td>
                                                        <span class="badge badge-danger">@lang('message.dashboard.merchant.payment.refund')</span>
                                                    </td>
                                                @endif
                                            </tr>
                                        @endforeach
