	...
	<tr>
	  <td>
	   <table>
		  ...
		  <tr>
			<td style="font-size:15px; color:#4e5c6e; line-height:22px;">1 {{$transactionDetails->fromWallet->currency->code}} = {{ formatNumber($transactionDetails->exchange_rate) }} {{$transactionDetails->toWallet->currency->code}}</td>
		  </tr>
		  </table>
	  </td>
	  </tr>
