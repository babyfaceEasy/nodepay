                ...
                <div class="card">
                    <div class="card-header">
                     ...
                     <div class="wap-wed mt20 mb20">
                        ...
                        <p style="text-align: center; line-height:25px;" class="mb20"><strong>{{$defaultCurrency->code}}</strong> of <strong>{{ formatNumber($transInfo['defaultAmnt']) }}</strong>
                          @lang('message.dashboard.exchange.confirm.has-exchanged-to') <strong>
                        {{  moneyFormat($transInfo['currCode'], isset($transInfo['convertedAmnt']) ? formatNumber($transInfo['convertedAmnt']) : 0.00) }}

                      </strong><br/>@lang('message.dashboard.exchange.confirm.exchange-rate'):<strong>1 {{$defaultCurrency->code}}</strong> = {{$transInfo['dCurrencyRate']}}
