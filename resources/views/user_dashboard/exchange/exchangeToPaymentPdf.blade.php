	    ...
	    <tr>
		  <td>
		   <table>
			  ...
			  <tr>
				<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{$transactionDetails->fromWallet->currency->code}}</td>
			  </tr>
			  <br><br>
			  ...
			  <tr>
				<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{$transactionDetails->toWallet->currency->code}}</td>
			  </tr>
			  <br><br>
			  ...
			  <tr>
				<td style="font-size:15px; color:#4e5c6e; line-height:22px;">1 {{$transactionDetails->fromWallet->currency->code}} = {{ formatNumber(1/$transactionDetails->exchange_rate)}} {{$transactionDetails->toWallet->currency->code}}</td>
			  </tr>
			  </table>
		  </td>
		  </tr>
		  ...
		  <td>
		   <table style="margin-top:20px; width:300px;">
			  ...
			  <tr>
				...
				<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transactionDetails->fromWallet->currency->symbol, formatNumber($transactionDetails->amount)) }}</td>
			  </tr>
			  <tr style="padding-bottom:10px;">
				<td style="font-size:15px; color:#000000;">@lang('message.dashboard.left-table.fee')</td>
				<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transactionDetails->fromWallet->currency->symbol, formatNumber($transactionDetails->fee)) }}</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transactionDetails->fromWallet->currency->symbol, formatNumber($transactionDetails->amount + $transactionDetails->fee)) }}</td>
			  </tr>
			  </table>
		    </td>
		  </tr>
