                ...
                <div class="card">
                    <div class="card-header">
                     ...
                     <div class="wap-wed mt20 mb20">
                        ...
                        {{-- <h5 class="text-center mt10">@lang('message.dashboard.send-request.request.success.accept-amount') : {{$transInfo['currSymbol']}} {{decimalFormat($transInfo['amount'])}}</h5> --}}
                    ...
                    <div class="card-footer" style="margin-top: 10px">
                            <div class="text-center">
                                ...
                                {{-- <a href="{{url('request-accept-amount/print')}}/{{$transInfo['trans_id']}}" target="_blank" class="btn btn-cust"> --}}
