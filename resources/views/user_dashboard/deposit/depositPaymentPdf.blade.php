      ...
      <table>
	    <tr>
		  <td>
		   <table>
			  <tr>
				<td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">@lang('message.dashboard.left-table.deposit.deposited-via')</td>
			  </tr>
			  <tr>
			  ...
			  <br><br>
			  <tr>
				<td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">@lang('message.dashboard.left-table.deposit.deposited-to')</td>
			  </tr>
			  <tr>
		...
		<tr>
		  <td>
		   ...
		   <table style="margin-top:20px; width:300px;">
			  ...
			  <tr>
				<td style="font-size:15px; color:#000000;">@lang('message.dashboard.left-table.deposit.deposited-amount')</td>
