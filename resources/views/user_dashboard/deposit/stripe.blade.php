                            ...
                            <form action="{{URL::to('deposit/stripe_payment_store')}}" method="post" id="payment-form">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        {{-- <label for="usr">@lang('message.dashboard.deposit.deposit-stripe-form.mm-yy')</label> --}}
                                        <label for="usr">{{ __('mm-yy') }}</label>
                                        <div id="card-expiry"></div>
                                    </div>
                                    <div class="form-group col-md-3">
                                        {{-- <label for="usr">@lang('message.dashboard.deposit.deposit-stripe-form.cvc')</label> --}}
