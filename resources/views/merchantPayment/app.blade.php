              ...
              <div class="row">
                <div class="col-md-12">
                    @if($isMerchantAvailable)
                      <h1>
                       ...
                       ?>
                        {{ number_format((float) ($amount), 2, '.', '') }} {{$currency->code}}
                      </h1>
                ...
                <div class="col-md-12">
                  <div class="bs-callout bs-callout-danger">
                    ...
                    @if(!$isMerchantAvailable)
                      <h4 style="color:red">Merchant Not Found ! Please try with valid merchant.</h4>
                     @else
                    <p>The recipient underwent a special verification and confirmed his reliability</p>
                      @endif
                  </div>
                          ...
                          <div class="tab-pane" id="payment">
                            ...
                            <form action="{{url('payment/mts_pay')}}" id="Mts" name="Mts" method="POST" accept-charset="utf-8" style="display: none;">
                             {{csrf_field()}}
                              <div class="row">
                                ...
                                {{-- <div class="col-md-4">
                                  <div class="form-group">
                                    <img src='{{asset("public/images/payment_gateway/Mts.jpg")}}' style="border:0;" alt=" " height="59" width="170">
                                  </div>
                                </div> --}}
                                <div class="col-md-12">
                                  ...
                                  <div class="pull-right">
                                    <a href="#home" data-toggle="tab" class="btn btn-default">Cancel</a>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="bs-callout-warning">
                                    <p>Payment is made on a secure page. When making a payment, you agree to the Terms of Agreement</p>
                                  </div>
                                  <div class="pull-right">
                                    <a href="#home" data-toggle="tab" class="btn btn-default">Cancel</a>
                                    <button type="submit" class="btn btn-primary">Go to payment</button>
                           ...
                           <!--- CoinPayments GATEWAY START-->
                            <form id="Coinpayments" name="coinpayments" method="post" action="{{url('payment/coinpayments')}}" accept-charset="UTF-8" style="display: none;">
                              ...
                              <input name="merchant" value="{{isset($paymentInfo['merchant_id']) ? $paymentInfo['merchant_id'] : ''}}" type="hidden">
                              <input name="merchant_uuid" value="{{isset($paymentInfo['merchant']) ? $paymentInfo['merchant'] : ''}}" type="hidden">
                              <input name="currency" value="{{isset($currency) ? $currency->code : ''}}" type="hidden">
                              <input class="form-control" name="amount" value="{{ $amount }}" type="hidden">
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="bs-callout-warning">
