...
class UsersDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return datatables()
            ...
            {
                return isset($user->carrierCode) && isset($user->phone) ? $user->carrierCode.$user->phone : '-';
            })
    ...
    {
        $query = User::with(['document_verification','role:id,display_name','user_detail'])->select('users.*');
