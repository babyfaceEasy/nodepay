...
class CustomerController extends Controller
{
    ...
    {
        // dd(session()->all());
        // dd(session()->get('google2fa')['auth_time']);
    ...
    public function updateProfileInfo(Request $request)
    {
        ...
        if ($_POST)
        {
            ...
            else
            {
                ...
                $UserDetail             = UserDetail::firstOrNew(['user_id' => Auth::user()->id]);
    ...
    public function personalId()
    {
        ...
        $data['user'] = $user = User::find(Auth::user()->id);
        // dd($user->document_verification->file);
    ...
    public function personalAddress()
    {
        ...
        // dd($documentVerification->file->filename);
